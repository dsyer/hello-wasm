...
var Module = (function () {
  ...
  return (
    function (Module) {
      ...
      } function UTF8ToString(ptr, maxBytesToRead) { return ptr ? UTF8ArrayToString(HEAPU8, ptr, maxBytesToRead) : "" } var buffer, HEAP8, HEAPU8, HEAP16, HEAPU16, HEAP32, HEAPU32, HEAPF32, HEAPF64;
      ...
      } function _emscripten_memcpy_big(dest, src, num) { HEAPU8.copyWithin(dest, src, src + num) } var SYSCALLS = {
      ...
      function _fd_write(fd, iov, iovcnt, pnum) {
        ...
        for (var i = 0;
          ...
          for (var j = 0;
            j < len;
            j++) { SYSCALLS.printChar(fd, HEAPU8[ptr + j]) } num += len
        } HEAP32[pnum >> 2] = num;
        return 0
      } function _time(ptr) {
        var ret = Date.now() / 1e3 | 0;
        if (ptr) { HEAP32[ptr >> 2] = ret } return ret
      } var asmLibraryArg = { "b": _emscripten_memcpy_big, "a": _fd_write, "c": _time };
      var asm = createWasm();
      ...
      var _printit = Module["_printit"] = function () { return (_printit = Module["_printit"] = Module["asm"]["f"]).apply(null, arguments) };
      ...
      function callMain(args) {
        ...
        try {
          ...
          if (e instanceof ExitStatus || e == "unwind") { return } var toLog = e;
